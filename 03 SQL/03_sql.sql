...
/**
Select names of all empty test groups 
(group name starts with “TEST-”)
**/
SELECT name 
FROM group g
...
/**
Select user first names and last names for the users that have Victor as a first name and are not
members of any test groups 
...
/**
Select users and groups for which user was 
created before the group for which he(she) is member of
**/
